...
import {
  ...
  SettingItem,
  TextInput,
} from '../components/Profile/Containers';
    ...
    <View style={styles.body}>
      <View style={styles.profileInfo}>
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.name}>Чмоня Уважаемый</Text>
          <Text style={styles.status}>Online</Text>
          <View style={styles.actions}>
            <ActionButton name={'Звонок'}><VideoIcon /></ActionButton>
            <ActionButton name={'Профиль'}><ProfileIcon /></ActionButton>
            <ActionButton name={'Звук'}><SoundIcon /></ActionButton>
            <ActionButton name={'Измен.'}><EditIcon /></ActionButton>
          </View>
        </View>
      </View>
      <View style={styles.settings}>
        <OwnerSettings toggleSwitch={toggleSwitch} isEnabled={isEnabled} />
      </View>
      {/* <Text>Text from props: {test}</Text> */}
      <Button
        title="Go to another profile screen"
